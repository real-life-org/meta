...
| Path | Content |
|---|---|
| `overview/` | the layer picture: `layers.svg` adapts to the viewer's browser language; `layers.en.svg` and `layers.de.svg` are fixed-language copies for pages that set their own language; the cells; the seams |
